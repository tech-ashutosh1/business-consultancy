                    ...
                    <form action="{{ route('blog.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="e.g., 5 Ways to Improve Your Business Strategy">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" 
                                      ...
                                      placeholder="A brief summary that appears in the blog listing...">{{ old('excerpt') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="content" 
                                      ...
                                      rows="15"
                                      required
                                      class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition outline-none resize-y"
